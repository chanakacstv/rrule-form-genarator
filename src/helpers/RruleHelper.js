export const RruleHelper = Object.freeze({
  ...
  MONTH_DAYS: [
    ...
    { label: '13', value: 13, isSelected: false },
    { label: '14', value: 14, isSelected: false },
    { label: '15', value: 15, isSelected: false },
    { label: '16', value: 16, isSelected: false },
    { label: '17', value: 17, isSelected: false },
    { label: '18', value: 18, isSelected: false },
    { label: '19', value: 19, isSelected: false },
    { label: '20', value: 20, isSelected: false },
    { label: '21', value: 21, isSelected: false },
    { label: '22', value: 22, isSelected: false },
    { label: '23', value: 23, isSelected: false },
    { label: '24', value: 24, isSelected: false },
    { label: '25', value: 25, isSelected: false },
    { label: '26', value: 26, isSelected: false },
    { label: '27', value: 27, isSelected: false },
    { label: '28', value: 28, isSelected: false },
    { label: '29', value: 29, isSelected: false },
    { label: '30', value: 30, isSelected: false },
    { label: '31', value: 31, isSelected: false },
    { label: 'Last Day', value: -1, isSelected: false }
  ],
